-- ============================================================================
-- 045: فك ربط PPP ثم حذفها — للمسؤول فقط (تجهيز بيئة العمل)
-- ============================================================================
-- is_used / 🔴 مستخدم = علامة من Excel أو تجديد سابق — ليست سبب المنع.
-- المنع الفعلي: customer_credential_usage (تخصيص نشط) أو subscription_periods.
-- المسؤول: يفك الربط تلقائياً ثم يحذف. الموظف: يبقى المنع كما هو.
