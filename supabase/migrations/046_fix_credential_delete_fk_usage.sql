-- ============================================================================
-- 046: حذf سجلات customer_credential_usage قبل حذf PPP (FK NOT NULL)
-- ============================================================================
-- released_at لا يكفي — credential_id NOT NULL يمنع DELETE على internet_credentials.
-- المسؤول: يحذف سجلات الربط ثم يفك subscription_periods ثم يحذف اليوزر.
