-- ============================================================================
-- 044: تجاوز admin/super_admin في حذف PPP (مثل requirePermission في API)
-- ============================================================================
-- has_permission() لا يمنح admin تلقائياً delete_records — بينما API Route يمرّره.
-- النتيجة: insufficient permission من RPC رغم أن المسؤول يرى زر الحذf.
