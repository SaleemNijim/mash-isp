-- ============================================================
-- 026: إنشاء اشتراك PPP — ربط username/password من المخزون
-- ============================================================

DROP FUNCTION IF EXISTS create_subscription_with_period(UUID, TEXT, NUMERIC, DATE, DATE, TEXT, TEXT, NUMERIC, NUMERIC, NUMERIC, NUMERIC, NUMERIC, TIMESTAMPTZ);
